...
Pod::Spec.new do |s|
  s.name             = 'MHSoftUI'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MHSoftUI.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Mumtaz Hussain/MHSoftUI'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mumtaz Hussain' => 'mumtaz_hussain13@yahoo.com' }
  s.source           = { :git => 'https://github.com/Mumtaz Hussain/MHSoftUI.git', :tag => s.version.to_s }
